...
/**
 * The `Scaner` class represents a scanner with various properties and
 * functionalities. It includes information about dimensions, properties,
 * connections, and functionality. This class provides methods to retrieve
 * information, control power, clean the buffer, and perform scanning
 * operations.
 *
 * @author [Andriy]
 * @version 1.0
